...
```html
<script src="https://d26b395fwzu5fz.cloudfront.net/keen-tracking-2.0.0.min.js"></script>
```
...
}('Keen','https://d26b395fwzu5fz.cloudfront.net/keen-tracking-2.0.0.min.js',this);
