...
export const listener = function(ctx){
  ...
  function listenerObj(str){
    if (!str) return;
    if (this instanceof listenerObj === false) {
      return new listenerObj(str);
    }
    this.selector = str;
    return this;
  }

  listenerObj.prototype.on = function(str, fn){
    var self = this;
  ...
  listenerObj.prototype.once = function(str, fn){
    var self = this;
    function on() {
      self.off(str, on);
  ...
  listenerObj.prototype.off = function(str, fn){
