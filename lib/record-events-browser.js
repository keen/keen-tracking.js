...
function send({ url, extendedEventsHash, callback, configObject = {}, eventCollection}){
  ...
  if (requestType === 'beacon' || requestType === 'img') {
    ...
    if (getRequestUrlOkLength) {
      ...
      attemptPostXhr.call(this, url, extendedEventsHash,
          'Beacon URL length exceeds current browser limit, and XHR is not supported.', callback)
    }
    return this;
  }
  ...
  if (getRequestUrlOkLength) {
    ...
    sendJSONp.call(this, getRequestUrl, callback);
    return this;
  }

  attemptPostXhr.call(this, url, extendedEventsHash,
              'JSONp URL length exceeds current browser limit, and XHR is not supported.', callback);
  return this;
}
